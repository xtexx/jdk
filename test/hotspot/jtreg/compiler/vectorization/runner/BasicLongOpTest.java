...
public class BasicLongOpTest extends VectorizationTestRunner {
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx512vl", "true", "rvv", "true", "lsx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"sve", "true", "avx512dq", "true", "rvv", "true", "lsx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"sve", "true", "sse4.1", "true", "rvv", "true", "lsx", "true"},
        counts = {IRNode.ADD_VL, ">0"})
    @IR(applyIfCPUFeatureOr = {"sve", "true", "sse4.1", "true", "rvv", "true", "lsx", "true"},
        counts = {IRNode.MUL_VL, ">0"})
