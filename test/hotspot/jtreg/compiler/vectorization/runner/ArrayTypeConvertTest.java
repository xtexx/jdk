...
public class ArrayTypeConvertTest extends VectorizationTestRunner {
    ...
    // ---------------- Convert I/L to F/D ----------------
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"sve", "true", "avx512dq", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx512dq", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx2", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"rvv", "true", "lasx", "true"},
    ...
    // ---------------- Convert F/D to I/L ----------------
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx", "true", "avx10_2", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx512dq", "true", "avx10_2", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"sve", "true", "avx", "true", "avx10_2", "true", "rvv", "true", "lasx", "true"},
    ...
    @Test
    @IR(applyIfCPUFeatureOr = {"asimd", "true", "avx2", "true", "avx10_2", "true", "rvv", "true", "lasx", "true"},
        applyIfOr = {"AlignVector", "false", "UseCompactObjectHeaders", "false"},
